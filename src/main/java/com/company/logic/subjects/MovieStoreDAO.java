...
public class MovieStoreDAO {
    ...
    public MovieStoreDAO(String DBName, String ip, int port) throws Exception {
        Class.forName("org.postgresql.Driver");
    ...
    public void deleteAllFilms() {
        try {
            PreparedStatement statement = connection.prepareStatement("TRUNCATE Films RESTART IDENTITY CASCADE");
            statement.executeUpdate();
            System.out.println("Films table was cleared");
        } catch (SQLException e) {
            System.out.println("Films table wasn't cleared!");
    ...
    public void deleteAllGenres() {
        try {
            PreparedStatement statement = connection.prepareStatement("TRUNCATE Genres RESTART IDENTITY CASCADE;");
            statement.executeUpdate();
            System.out.println("Genres table was cleared");
        } catch (SQLException e) {
            System.out.println("Genres table wasn't cleared!");
            System.out.println(" >>     " + e.getMessage());
        }
    }
    ...
    public Film getFilmByName(String filmName) {
        ...
        try {
            ...
            Film film = new Film(queryResult.getInt("filmId"), queryResult.getString("filmName"),
                    queryResult.getFloat("duration"), getGenreById(queryResult.getInt("genreId")));
    ...
    public Genre getGenreById(int id) {
        ...
        try {
            ...
            System.out.println("Error during getting genre");
            System.out.println(" >> " + e.getMessage());
            return null;
        }
    }
